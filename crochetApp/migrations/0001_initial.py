# Generated by Django 3.2.3 on 2021-06-12 23:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='crochetApp.user')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profiles', to='crochetApp.user')),
            ],
        ),
        migrations.AddField(
            model_name='post',
